...
# ╔═╡ cd05feb3-3018-423e-a391-6aa1714fd37d
question_box(md"""
Can we discuss how command line syntax works. What is happening when you type `julia --project -e 'using Pkg; Pkg.instantiate();` What is the difference between the `--` and `-`?""")
