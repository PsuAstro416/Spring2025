...
question_box(md"We saw a table of 15 fonts to write “phi,” is there a font for greek letters that’s used most often in figures or papers?")
...
question_box(md"For the scatter plot in the lab this week, how could we have made the points partly transparent?")
...
# ╔═╡ 9189fdeb-2d44-4de1-beb5-b77780ae60d5
md"""
Transparency ("alpha"): $(@bind plt_α Slider(0:0.1:1, default=1))
"""
...
# ╔═╡ b21b471e-ab5f-4728-a481-a15a5b6e6ca6
let
	m = 40
	z = randn(n,m)
	z = (1:n)' * 1 .+ 0.5.* randn(m)
...
question_box(md"Are there certain colors/combination of colors that should be avoided when presenting visuals?")
...
md"""
K in K-fold Validation: $(@bind k Slider(2:n; default= 5))
"""

# ╔═╡ effb29fd-528c-404b-b24c-565dec1eef89
 train_idx, val_idx = kfolds(n, k);

# ╔═╡ 3d38d698-3554-448d-86da-b9182bc94616
let
	plt = plot(legend=:none, xlabel="Data index", ylabel="Fold Index", title="$k-fold Cross Validation")
	for r in 1:length(train_idx)
		scatter!(plt, train_idx[r], fill(r,length(train_idx[r])), mc=:blue)
		scatter!(plt, val_idx[r], fill(r,length(val_idx[r])), mc=:red)
	end
	plt
end
...
manifest_format = "2.0"
project_hash = "1d59c78191b161356e7e9920811c25571686f043"
